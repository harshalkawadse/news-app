...
function Home() {
    ...
    const loadnews = async () => {
        try {
            const response = await axios.get(`https://newsapi.org/v2/everything?q=${searchQuery}&from=2024-03-24&to=2024-03-24&sortBy=popularity&apiKey=${process.env.REACT_APP_NEWS_API_KEY}`);
